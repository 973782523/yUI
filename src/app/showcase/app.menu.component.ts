    ...
    template: `
        <div class="layout-sidebar" [ngClass]="{'active': active}">
            ...
            <div class="layout-menu">
                ...
                <div class="menu-category">组件学习</div>
                <div class="menu-items">
                    <a [routerLink]=" ['boxAnimation']" routerLinkActive="router-link-exact-active">下拉框动画</a>
                </div>
            </div>
        </div>
    `,
...
export class AppMenuComponent {
    ...
    routes = [
        ...
        {
            label: '组件学习', value: 'componentLearn',
            items: [
                {label: '下拉框动画', value: '/boxAnimation'}
            ]
        },
    ];
