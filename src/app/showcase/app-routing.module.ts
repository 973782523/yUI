        ...
        RouterModule.forRoot([
            {path: '', component: LandingComponent, pathMatch: 'full'},
            {
                ...
                children: [
                    ...
                    {
                        path: 'breadcrumb',
                        loadChildren: () => import('./components/breadcrumb/breadcrumbdemo.module').then(m => m.BreadcrumbDemoModule)
                    },
                    ...
                    {
                        path: 'cascadeselect',
                        loadChildren: () => import('./components/cascadeselect/cascadeselectdemo.module').then(m => m.CascadeSelectDemoModule)
                    },
                    {
                        path: 'carousel',
                        loadChildren: () => import('./components/carousel/carouseldemo.module').then(m => m.CarouselDemoModule)
                    },
                    ...
                    {path: 'chips', loadChildren: () => import('./components/chips/chipsdemo.module').then(m => m.ChipsDemoModule)},
                    {
                        ...
                        loadChildren: () => import('./components/codehighlighter/codehighlighterdemo.module').then(m => m.CodeHighlighterDemoModule)
                    },
                    {
                        path: 'colorpicker',
                    ...
                    {
                        path: 'confirmdialog',
                        loadChildren: () => import('./components/confirmdialog/confirmdialogdemo.module').then(m => m.ConfirmDialogDemoModule)
                    },
                    {
                        path: 'confirmpopup',
                        loadChildren: () => import('./components/confirmpopup/confirmpopupdemo.module').then(m => m.ConfirmPopupDemoModule)
                    },
                    {
                        path: 'contextmenu',
                        loadChildren: () => import('./components/contextmenu/contextmenudemo.module').then(m => m.ContextMenuDemoModule)
                    },
                    {
                        path: 'dataview',
                        loadChildren: () => import('./components/dataview/dataviewdemo.module').then(m => m.DataViewDemoModule)
                    },
                    ...
                    {
                        path: 'dynamicdialog',
                        loadChildren: () => import('./components/dynamicdialog/dynamicdialogdemo.module').then(m => m.DynamicDialogDemoModule)
                    },
                    {
                        path: 'dragdrop',
                        loadChildren: () => import('./components/dragdrop/dragdropdemo.module').then(m => m.DragDropDemoModule)
                    },
                    {
                        path: 'dropdown',
                        loadChildren: () => import('./components/dropdown/dropdowndemo.module').then(m => m.DropdownDemoModule)
                    },
                    {path: 'editor', loadChildren: () => import('./components/editor/editordemo.module').then(m => m.EditorDemoModule)},
                    {
                        path: 'fieldset',
                        loadChildren: () => import('./components/fieldset/fieldsetdemo.module').then(m => m.FieldsetDemoModule)
                    },
                    {
                        path: 'fileupload',
                        loadChildren: () => import('./components/fileupload/fileuploaddemo.module').then(m => m.FileUploadDemoModule)
                    },
                    {
                        path: 'floatlabel',
                        loadChildren: () => import('./components/floatlabel/floatlabeldemo.module').then(m => m.FloatLabelDemoModule)
                    },
                    {
                        path: 'filterservice',
                        loadChildren: () => import('./components/filterservice/filterservicedemo.module').then(m => m.FilterServiceDemoModule)
                    },
                    {
                        path: 'focustrap',
                        loadChildren: () => import('./components/focustrap/focustrapdemo.module').then(m => m.FocusTrapDemoModule)
                    },
                    {
                        path: 'fullcalendar',
                        loadChildren: () => import('./components/fullcalendar/fullcalendardemo.module').then(m => m.FullCalendarDemoModule)
                    },
                    {
                        path: 'galleria',
                        loadChildren: () => import('./components/galleria/galleriademo.module').then(m => m.GalleriaDemoModule)
                    },
                    ...
                    {
                        path: 'inputnumber',
                        loadChildren: () => import('./components/inputnumber/inputnumberdemo.module').then(m => m.InputNumberDemoModule)
                    },
                    {
                        path: 'inputswitch',
                        loadChildren: () => import('./components/inputswitch/inputswitchdemo.module').then(m => m.InputSwitchDemoModule)
                    },
                    {
                        path: 'inputtext',
                        loadChildren: () => import('./components/inputtext/inputtextdemo.module').then(m => m.InputTextDemoModule)
                    },
                    {
                        path: 'inputgroup',
                        loadChildren: () => import('./components/inputgroup/inputgroupdemo.module').then(m => m.InputGroupDemoModule)
                    },
                    {
                        path: 'inputtextarea',
                        loadChildren: () => import('./components/inputtextarea/inputtextareademo.module').then(m => m.InputTextareaDemoModule)
                    },
                    ...
                    {
                        path: 'keyfilter',
                        loadChildren: () => import('./components/keyfilter/keyfilterdemo.module').then(m => m.KeyFilterDemoModule)
                    },
                    ...
                    {
                        path: 'megamenu',
                        loadChildren: () => import('./components/megamenu/megamenudemo.module').then(m => m.MegaMenuDemoModule)
                    },
                    ...
                    {
                        path: 'menumodel',
                        loadChildren: () => import('./components/menumodel/menumodeldemo.module').then(m => m.MenuModelDemoModule)
                    },
                    {
                        path: 'messages',
                        loadChildren: () => import('./components/messages/messagesdemo.module').then(m => m.MessagesDemoModule)
                    },
                    {
                        path: 'multiselect',
                    ...
                    {
                        path: 'orderlist',
                        loadChildren: () => import('./components/orderlist/orderlistdemo.module').then(m => m.OrderListDemoModule)
                    },
                    {
                        path: 'organizationchart',
                        loadChildren: () => import('./components/organizationchart/organizationchartdemo.module').then(m => m.OrganizationChartDemoModule)
                    },
                    {
                        path: 'overlaypanel',
                        loadChildren: () => import('./components/overlaypanel/overlaypaneldemo.module').then(m => m.OverlayPanelDemoModule)
                    },
                    {
                        path: 'paginator',
                        loadChildren: () => import('./components/paginator/paginatordemo.module').then(m => m.PaginatorDemoModule)
                    },
                    {path: 'panel', loadChildren: () => import('./components/panel/paneldemo.module').then(m => m.PanelDemoModule)},
                    {
                        path: 'panelmenu',
                        loadChildren: () => import('./components/panelmenu/panelmenudemo.module').then(m => m.PanelMenuDemoModule)
                    },
                    {
                        path: 'password',
                        loadChildren: () => import('./components/password/passworddemo.module').then(m => m.PasswordDemoModule)
                    },
                    {
                        path: 'picklist',
                        loadChildren: () => import('./components/picklist/picklistdemo.module').then(m => m.PickListDemoModule)
                    },
                    {
                        path: 'progressbar',
                    ...
                    },
                    {
                        ...
                        loadChildren: () => import('./components/progressspinner/progressspinnerdemo.module').then(m => m.ProgressSpinnerDemoModule)
                    },
                    {
                        path: 'radiobutton',
                    ...
                    {
                        path: 'scrollpanel',
                        loadChildren: () => import('./components/scrollpanel/scrollpaneldemo.module').then(m => m.ScrollPanelDemoModule)
                    },
                    {
                        path: 'scrolltop',
                        loadChildren: () => import('./components/scrolltop/scrolltopdemo.module').then(m => m.ScrollTopDemoModule)
                    },
                    {
                        path: 'selectbutton',
                        loadChildren: () => import('./components/selectbutton/selectbuttondemo.module').then(m => m.SelectButtonDemoModule)
                    },
                    ...
                    {
                        path: 'slidemenu',
                        loadChildren: () => import('./components/slidemenu/slidemenudemo.module').then(m => m.SlideMenuDemoModule)
                    },
                    {path: 'slider', loadChildren: () => import('./components/slider/sliderdemo.module').then(m => m.SliderDemoModule)},
                    {
                        path: 'speeddial',
                        loadChildren: () => import('./components/speeddial/speeddialdemo.module').then(m => m.SpeedDialDemoModule)
                    },
                    {
                        path: 'splitbutton',
                    ...
                    {
                        path: 'splitter',
                        loadChildren: () => import('./components/splitter/splitterdemo.module').then(m => m.SplitterDemoModule)
                    },
                    ...
                    {
                        path: 'styleclass',
                        loadChildren: () => import('./components/styleclass/styleclassdemo.module').then(m => m.StyleClassDemoModule)
                    },
                    ...
                    {
                        path: 'terminal',
                        loadChildren: () => import('./components/terminal/terminaldemo.module').then(m => m.TerminalDemoModule)
                    },
                    {
                        path: 'tieredmenu',
                        loadChildren: () => import('./components/tieredmenu/tieredmenudemo.module').then(m => m.TieredMenuDemoModule)
                    },
                    {
                        path: 'timeline',
                        loadChildren: () => import('./components/timeline/timelinedemo.module').then(m => m.TimelineDemoModule)
                    },
                    {path: 'toast', loadChildren: () => import('./components/toast/toastdemo.module').then(m => m.ToastDemoModule)},
                    {
                        path: 'togglebutton',
                        loadChildren: () => import('./components/togglebutton/togglebuttondemo.module').then(m => m.ToggleButtonDemoModule)
                    },
                    ...
                    {
                        path: 'treeselect',
                        loadChildren: () => import('./components/treeselect/treeselectdemo.module').then(m => m.TreeSelectDemoModule)
                    },
                    {
                        path: 'treetable',
                        loadChildren: () => import('./components/treetable/treetabledemo.module').then(m => m.TreeTableDemoModule)
                    },
                    {
                        path: 'tristatecheckbox',
                        loadChildren: () => import('./components/tristatecheckbox/tristatecheckboxdemo.module').then(m => m.TriStateCheckboxDemoModule)
                    },
                    {
                        path: 'virtualscroller',
                        loadChildren: () => import('./components/virtualscroller/virtualscrollerdemo.module').then(m => m.VirtualScrollerDemoModule)
                    },
                    {
                        path: 'accessibility',
                        loadChildren: () => import('./components/accessibility/accessibilitydemo.module').then(m => m.AccessibilityDemoModule)
                    },
                    {
                        path: 'scroller',
                        loadChildren: () => import('./components/scroller/scrollerdemo.module').then(m => m.ScrollerDemoModule)
                    },
                    {path: 'uikit', loadChildren: () => import('./components/uikit/uikit.module').then(m => m.UIKitModule)},
                    {
                        path: 'autofocus',
                        loadChildren: () => import('./components/autofocus/autofocusdemo.module').then(m => m.AutoFocusDemoModule)
                    },
                    {
                        path: 'boxAnimation',
                        loadChildren: () => import('./yl-show/yl-menu-view/yl-menu-view.module').then(m => m.YlMenuViewModule)
                    }
                ],
            },
